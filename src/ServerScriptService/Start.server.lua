...
PhysicsService:RegisterCollisionGroup("Chest")
PhysicsService:CollisionGroupSetCollidable("Player", "Monster", true)
PhysicsService:CollisionGroupSetCollidable("Monster", "Monster", false)
PhysicsService:CollisionGroupSetCollidable("Item", "Item", false)
PhysicsService:CollisionGroupSetCollidable("Player", "Item", false)
PhysicsService:CollisionGroupSetCollidable("Monster", "Item", false)
PhysicsService:CollisionGroupSetCollidable("Chest", "Chest", false)
PhysicsService:CollisionGroupSetCollidable("Chest", "Item", false)