...
GameConfig.PlayerAttributeId = {
    ...
    Endurance = 1003,
    WalkSpeed = 1004,
    EnduranceConsume = 1005,
    EnduranceRecovery = 1006,
    JumpPower = 1007,
    Weight = 1008,
    Lucky = 1009,
    CriticalProbability = 1010,
    CriticalValue = 1011,
    AttackPoint = 2001,
    HealthPoint = 2002,
    EndurancePoint = 2003,
    WalkSpeedPoint = 2004,
    EnduranceConsumePoint = 2005,
    EnduranceRecoveryPoint = 2006,
    JumpPowerPoint = 2007,
    WeightPoint = 2008,
    LuckyPoint = 2009,
    CriticalProbabilityPoint = 2010,
    CriticalValuePoint = 2011,
}
...
GameConfig.PlayerInitAttribute = {
    ...
    EnduranceConsume = ConstantConfig:GetByConstant("InitialEnduranceConsume").Effect1,
